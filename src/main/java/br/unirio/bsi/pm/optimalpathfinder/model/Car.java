...
public class Car {
	...
	private ArrayList<Coordinate2D> positionStack; // keeps a history of car positions
	private ArrayList<Coordinate2D> speedStack; // keeps a history of the speed at a given position index.
	...
	/**
	 * Sum the current speed to the current position and add a new position of the result of this sum.
	 */
	...
	/**
	 * Returns the car's next position considering no speed change. This is used to draw the next move circle grid.  
	 * Note that this method doesn't add a new position to the car
	 */
    ...
    /**
     * Set the car's current speed to zero. This is used when the car is moved with path finder.
     */
    public void brake(){
